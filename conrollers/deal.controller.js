...
//get all deal
const getAllDeal = (request, response) => {
  ...
  //get deal by id 
const getDealById = (request, response) => {
...
//create a new deal
const createDeal = (request, response) => {
...
const updateDeal = (request, response) => {
  const id = parseInt(request.params.id)
  const { name, email } = request.body
...
//delete an deal
const deleteDeal = (request, response) => {
  const id = parseInt(request.params.id)
...
//export all controller of deal
module.exports = {getAllDeal , getDealById , createDeal , updateDeal , deleteDeal}